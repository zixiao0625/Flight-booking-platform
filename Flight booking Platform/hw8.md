...
**Assigned date:** Nov. 28, 2018

**Due date:** Dec. 8, 2018, at 11:59pm. Turn in your solution using `git`. You have 1.5 weeks for this assignment.

***Warning: This can potentially be a long assignment.***
...
(`int`). All usernames should be unique in the system. Each user can have any number of reservations. There are no restriction on passwords and you can just store them in plain text. Usernames and passwords are be case insensitive (this is the default for SQL Server).
...
Create any other tables or indexes you need for this assignment in `createTables.sql` (see below).
...
### Task 2C: Transaction management
